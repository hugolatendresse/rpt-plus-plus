...
# Usage: run_ash_datagen_release.sh [--perf] [--no-taskset] [--runs N] --case <1|2o|2t|3|4> rs|rst
set -euo pipefail
...
echo "=== Phase 2: running query_${QUERY}.sql with release build (${RUNS} runs, case ${CASE}) ==="
